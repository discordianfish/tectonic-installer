...
output "calico-network-policy" {
  value = "${module.calico-network-policy}"
}
...
output "module_bootkube" {
  value = "${module.module.bootkube}"
}

output "module_calico-network-policy" {
  value = "${module.module.calico-network-policy}"
}

output "module_dns" {
  value = "${module.module.dns}"
}

output "module_etcd" {
  value = "${module.module.etcd}"
}

output "module_flannel-vxlan" {
  value = "${module.module.flannel-vxlan}"
}

output "module_masters" {
  value = "${module.module.masters}"
}

output "module_tectonic" {
  value = "${module.module.tectonic}"
}

output "module_vnet" {
  value = "${module.module.vnet}"
}
...
output "vnet_api_external_fqdn" {
  value = "${module.vnet.api_external_fqdn}"
}
...
output "vnet_ingress_internal_fqdn" {
  value = "${module.vnet.ingress_internal_fqdn}"
}
